...
def verify_all_same_orientation(folder: str):
    """
...
def verify_dataset_integrity(folder: str):
    """
    ...
    for c in expected_train_identifiers:
        ...
        assert all([isfile(i) for i in
                    expected_image_files]), "some imag e files are missing for case %s. Expected files:\n %s" % (
        ...
        # check geometry for all modalities image files with label file
